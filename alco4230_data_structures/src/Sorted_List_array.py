...
class Sorted_List:
    ...
    def _binary_search(self, key):
        ...
        while low < high:
            # Find the middle of the current sub  array.
            ...
            if key > self._values[mid]:
                ...
                # Default: search the left sub array.
                high = mid
    ...
    def split(self):
        ...
        for i in range(len(self._values) - (len(self._values) // 2)):
