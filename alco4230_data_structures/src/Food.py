...
class Food:
    ...
    def origins():
        ...
        """
        string = ""
        for position in range(len(Food.ORIGIN)):
            string += f"{position:>2} {Food.ORIGIN[position]}\n"
...
Calories:  {self.calories}'''
    ...
    def __eq__(self, foods):
        ...
        -------------------------------------------------------
        Parameters:
            foods - [right side] Food object to compare to (Food)
        Returns:
            result - True if name and origin match, False otherwise (boolean)
        -------------------------------------------------------
        """
        result = (self.name.lower(), self.origin) == \
            (foods.name.lower(), foods.origin)
        return result

    def __lt__(self, foods):
        """
        -------------------------------------------------------
        ...
        Parameters:
            foods - [right side] Food object to compare to (Food)
        Returns:
            result - True if this food precedes or is equal to foods,
    ...
    def __le__(self, foods):
        ...
        -------------------------------------------------------
        """
        result = self < foods or self == foods
        return result
