...
class Sorted_List:
    ...
    def remove(self, key):
        ...
        -------------------------------------------------------
        """
        prev, curr, _ = self._linear_search(key)
        if curr is not None:
            if prev is None:
    ...
    def intersection(self, source1, source2):
        ...
        while source1_node is not None:
            ...
            _, c, _ = source2._linear_search(value)

            if c is not None:
                _, c, _ = self._linear_search(value)
    ...
    def __eq__(self, target):
        ...
        while equals and scurrent is not None:
